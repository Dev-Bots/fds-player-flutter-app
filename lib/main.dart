...
import 'package:dev_player_fds/Presentation/config/routes.dart';
        ...
        child: BlocProvider(
            ...
            child: MaterialApp(
              ...
              initialRoute: RouteGenerator
                  .homePage, // This needs to be changed to the front page/ or the splash screen when we make one
