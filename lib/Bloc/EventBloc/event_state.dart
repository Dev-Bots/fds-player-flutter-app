...
class ApplyingForEvent extends EventState {}

class AppliedForEvent extends EventState {}

class ApplyForEventFailed extends EventState {
  final String error;

  const ApplyForEventFailed({required this.error});

  @override
  List<Object> get props => [error];

  @override
  String toString() => 'ApplyForEventFailure { error: $error }';
}
